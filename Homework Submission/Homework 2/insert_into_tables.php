...
$sql_departments = "INSERT INTO departments
...
if (mysqli_query($link, $sql_departments)) {
    echo "Values inserted into Departments table\n";
} else {
    echo "Error: could not able to insert into table " .mysqli_error($link);
}

$sql_employees = "INSERT INTO employees (Employee_Id, First_Name, Last_Name, Email, Phone_Number,
...
if (mysqli_query($link, $sql_employees)) {
    echo "Values inserted into Employees table";
} else {
    echo "Error: could not able to insert into table " .mysqli_error($link);
}
